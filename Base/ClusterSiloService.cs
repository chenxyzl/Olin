...
{
    public class ClusterSiloService : IHostedService
    {
        private readonly ILogger<ClusterSiloService> _logger;
        private readonly IConfiguration _config;

        public ClusterSiloService(ILogger<ClusterSiloService> logger, ILoggerProvider loggerProvider,
