...
public partial class RpcItemMessage
{
	public static List<RpcItem> rpcItemsOuter = new()
	{
		...
		new RpcItem(200004, OpType.CS, typeof(Message.C2SOffline), typeof(Message.S2COffline), "Offline"),
		new RpcItem(200005, OpType.S, null, typeof(Message.SLoginElsewhere), "LoginElsewhere"),
		new RpcItem(200106, OpType.S, null, typeof(Message.SSyncReward), "SyncReward"),
		new RpcItem(200107, OpType.CS, typeof(Message.C2SMails), typeof(Message.S2CMails), "GetMails"),
	};
}
